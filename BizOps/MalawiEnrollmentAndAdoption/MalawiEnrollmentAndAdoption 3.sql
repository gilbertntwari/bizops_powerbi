...
MIN(AdoptionTargetInModelName) AS 'AdoptionTmoda', SUM(TotalAdopters) AS 'Currentadoptersenrolled', 
...
CASE WHEN BundleName IN('LR2023_Fruit Trees') THEN 'Trees'
ELSE 'Nada' END AS BucketName,


CASE WHEN BundleName IN('LR2023_Fruit Trees') THEN 'Fruit tree adoption'
ELSE 'Nada' END AS ImpactProofPointsName,

CASE WHEN BundleName IN('LR2023_Fruit Trees') THEN 0.0
...
debb.DistrictName IN('Thyolo', 'Mulanje')) as innerTable
