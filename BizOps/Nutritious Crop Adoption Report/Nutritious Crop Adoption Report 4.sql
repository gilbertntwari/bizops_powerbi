...
select Distinct CountryName, BundleName from v_ClientBundles

-- Choose the needed BundleNames
Where BundleName like '%Bean%' or BundleName like '%Cabbage%' or BundleName like '%Tomato%' or BundleName like '%Sukuma%' or BundleName like '%Spinach%'
...
and SeasonName in (@Season)

-- Order By
Order By CountryName, BundleName ASC